...
def get_args():
    ...
    parser.add_argument('--data_dir', type=str, default='/data/bzw/MRC/data/cnn',
                        help='data directory containing input')
    #parser.add_argument('--data_dir', type=str, default='./data/cnn', help='data directory containing input')
    parser.add_argument('--log_dir', type=str, default='./log/1',
                        help='directory containing tensorboard logs')
    parser.add_argument('--save_dir', type=str, default='./models/1',
    ...
    parser.add_argument('--eval_every', type=int, default=12000,
    ...
    #with tf.Session() as sess:
        ...
        for epoch in range(args.n_epoch):
            ...
            for dw,dsw, dt, qw, qt, nw,a, m_dw,m_dsw, m_qw, tt, \
                ...
                loss_, acc_, test = model.train(sess, dw, dsw,dt, qw, qt, nw, a, m_dw,m_dsw,
                ...
                if it % args.eval_every == 0 or \
                    ...
                    if valid_acc >= best_acc:
                        ...
                        ckpt_name = os.path.join(args.save_dir, "model")
